        ...
        <div class="col">
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM challenges_log WHERE challenge_by = $user_id AND status = 'completed' ORDER BY created_timestamp DESC";
                    ...
                    ?>
                        ...
                        <tr>
                            <td colspan="8" class="text-center text-danger">No Completed Challenges</td>
                        </tr>
