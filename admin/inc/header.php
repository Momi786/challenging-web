<?php
    ...
    require_once("../../php-apis/db-config.php");
?>
...
<!-- Mirrored from jobie.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Dec 2020 08:57:03 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="../css/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span class="text-black">Challenge Site</span>
