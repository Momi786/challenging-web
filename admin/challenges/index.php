			...
			<div class="container-fluid">
				<div class="row">
                    <table id="example" class="table table-bordered ">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * from challenges_log where challenge_by_claimed_result='win' AND accepted_by_claimed_result='win'";
                                $result = mysqli_query($conn,$query);
                                $count = mysqli_num_rows($result);
                                for ($i=0; $i < $count ; $i++) { 
                                    $data = mysqli_fetch_assoc($result);
                                    if($data['adminResult'] == null){
                                        $challenge_by = $data['challenge_by'];
                                    ...
                                    $winAmount = ($amount/100)*80;
                                    $adminAmount = $amount-$winAmount;
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($data['adminResult'] == null){ ?>
                                            <form action="result.php" method="post">
                                                ...
                                                <input type="hidden" name="challengeId" value="<?= $data['challenge_id'] ?>">
                                                <input type="hidden" name="winAmount" value="<?= $winAmount ?>">
                                                <input type="hidden" name="adminAmount" value="<?= $adminAmount ?>">
