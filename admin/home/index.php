                                ...
                                <a href="../home/users.php">
                                    <div class="media align-items-center">
                                        <span class="p-3 mr-3 border border-white rounded">
                                            <h3 class="fa fa-users text-white"></h3>
                                        </span>
                                        <div class="media-body text-right">
                                            <p class="fs-18 text-white mb-2">Total Users</p>
                                            <?php
                                                $query = "SELECT * from users";
                                                $result = mysqli_query($conn,$query);
                                                $count = mysqli_num_rows($result);
                                            ?>
                                            <span class="fs-48 text-white font-w600"><?= $count ?></span>
                                        </div>
                                    </div>
                                </a>
							</div>
								...
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<?php
											...
											$adminBalance = mysqli_fetch_assoc($result1);
										?>
										<p class="fs-18 text-white mb-2">Admin Balance</p>
										<span class="fs-48 text-white font-w600"><?= $adminBalance['balance'] ?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
                                <a href="../tournaments/">
									<div class="media align-items-center">
										...
										<div class="media-body text-right">
											<p class="fs-18 text-white mb-2">Tournamemts Dispute Chat</p>
												<?php
													$query = "SELECT * from chat_message where challenge_id=null";
													$result = mysqli_query($conn,$query);
													$count = mysqli_num_rows($result);
												?>
											<span class="fs-48 text-white font-w600"><?= $count ?></span>
							...
							<div class="card-body">
                                <a href="../challenges/">
									<div class="media align-items-center">
										...
										<div class="media-body text-right">
											<p class="fs-18 text-white mb-2">Challenges Dispute Chat</p>
												<?php
													$query = "SELECT * from chat_message where tournament_id=null";
													$result = mysqli_query($conn,$query);
													$count = mysqli_num_rows($result);
												?>
											<span class="fs-48 text-white font-w600"><?= $count ?></span>
